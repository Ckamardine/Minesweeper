class CharacterPacman
{
    ...
    update(){
        ...
        // imageObj.src = "pacman-"+this.orientation+".jpg";
        imageObj.src = "pacman-"+this.orientation+".png";
        var self = this;
    ...
    updateMemory(action, result){
        if(this.memory.length<50000){
            this.memory.push({ 
                                "Pacman action":action,
                                "Pacman result":result
                            });
            console.log("Pacman memory : "+ this.memory);
        }else{
                //startGame();
        }
        this.score+=result;
...
export default CharacterPacman;